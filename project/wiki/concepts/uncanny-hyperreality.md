...
Desk name for the compound Ryan locked 2026-09-05:

**Uncanny valley + the simulacrum being more real than real.**

Canonical expansion: [more real than real](more-real-than-real.md).
Also braids [hyperreality](hyperreality.md) and [simulacrum](simulacrum.md).

## Why the name

“Hyperreality” alone can drift into theory. “Uncanny” alone can stop at
creepy-almost. Together they name the niche where the copy is *strangely
preferable* — more familiar, more vivid, more believable than life — and
that preference is the point.

## Specimens

- [Skift TikTok Go Ambiente](../sources/skift-tiktok-go-ambiente-ai.md)
- [Newsweek Emily Rae](../sources/newsweek-emily-rae-ai-influencer.md)
